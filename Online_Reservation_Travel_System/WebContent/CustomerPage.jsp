...
<% 
	...
	out.print("<form method = \"post\" action = \"MakeOneWayTrip.jsp\"> <input type = \"submit\" value = \"ONE-WAY\"> </form>");
	out.print("<form method = \"post\" action = \"MakeRoundTrip.jsp\"> <input type = \"submit\" value = \"ROUND-TRIP\"></form>");
	out.print("<form method = \"post\" action = \"MakeMultiStopTrip.jsp\"> <input type = \"submit\" value = \"MULTI-STOP-TRIP\"></form>");
...
%>
	...
	<%
	out.print("<form method = \"post\" action = \"ReservationActions.jsp\">");
	...
	<%
	out.print("<form method = \"post\" action = \"FlightTicketActions.jsp\">");
	//find User_ID using username
	UserID = null;
	intUserID = 0;
	...
	<h2> Waiting List </h2>
	<%
	out.print("<form method = \"post\" action = \"WaitingListActions.jsp\"> ");
