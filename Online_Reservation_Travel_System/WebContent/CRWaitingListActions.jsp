...
try {
	...
	try{
		...
		out.print("<h3>There was a problem when trying to delete the user from the waiting list. Please go back to the Dashboard and try again.");
	}
...
%>
<br><form method = "post" action = "CustomerRepUserEdit.jsp"> <input type = "submit" value = "Customer Dashboard"> <input name = "User" type = "hidden" value = "<%out.print(request.getParameter("CustomerToHelp"));%>"></form>  <br>
</body>
</html>