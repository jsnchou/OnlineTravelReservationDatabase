...
<title>One-Way Confirmation Page</title>
</head>
<body>
...
int intFlight_Number = Integer.parseInt(flight_number);
...
4-4: 0 , waitlist
	*/
		...
		select = "SELECT aircraft_ID FROM OnlineResTravelSystem.Flight WHERE flight_number = "+ intFlight_Number +"";
		...
		//Create a SQL statement and execute
		stmt = con.createStatement();
		select = "SELECT COUNT(*) FROM OnlineResTravelSystem.Flight_Ticket WHERE flight_number = "+ intFlight_Number +"";
		ps = con.prepareStatement(select);
		result = ps.executeQuery();
		...
		//Create a SQL statement and execute
		stmt = con.createStatement();
		select = "SELECT COUNT(*) FROM OnlineResTravelSystem.Reservation WHERE flight_number = "+ intFlight_Number +"";
		ps = con.prepareStatement(select);
		result = ps.executeQuery();
		...
		// put the person on the waitlist
		if (difference == 0) {
			...
			ps.setInt(2,intFlight_Number);
			
			try {
				ps.executeUpdate();
				out.print("<br><b>Sorry. It seems that the flight that you want to book is currently full. We have added you to the waiting list.</b>");
				out.print("<br>");
				out.print("<b>You can now go back to the Dashboard to see that we have added you to the wiaitlist for your flight.</b>");
				
			} catch (Exception ex) {
				out.print("<br><b>You are still on the waitlist for this flight. Please wait until more seats are available. Thank you.</b>");
			}
		...
		// find a new seat number for the person and then using the info, make a flight tcket for them
		} else {
			// seat number
			...
			//Create a SQL statement and execute
			stmt = con.createStatement();
			select = "SELECT date_of_flight,departure_time,price FROM OnlineResTravelSystem.Flight WHERE flight_number = "+ intFlight_Number +"";
			ps = con.prepareStatement(select);
			result = ps.executeQuery();
			...
			out.print("<br><b>Your first class ticket has been booked. We have updated your queue of tickets. You can view this change in your login dashboard. </b>");
			out.print("<br>");
		...
		// put the person on the waitlist
				if (difference == 0) {
					...
					try {
						...
						out.print("<br><b>Sorry. It seems that the flight that you want to book is currently full. We have added you to the waiting list.</b>");
						out.print("<br>");
						out.print("<b>You can now go back to the Dashboard to see that we have added you to the waitlist for your flight.</b>");
				...
				// find a new seat number for the person and then using the info, make a flight tcket for them
					...
					out.print("<br><b>Your business class ticket has been booked. We have updated your queue of tickets. You can view this change in your login dashboard. </b>");
					out.print("<br>");
...
4-4: 0 , waitlist
	*/
		...
		// find a new seat number for the person and then using the info, make a flight tcket for them
			...
			out.print("<br><b>Your economy class ticket has been booked. We have updated your queue of tickets. You can view this change in your login dashboard. </b>");
			out.print("<br>");
...
4-4: 0 , waitlist
	*/
		...
		if (difference == 0) {
			...
			try {
				ps.executeUpdate();
				out.print("<br><b>Sorry. It seems that the flight that you want to reserve is currently full. We have added you to the waiting list.</b>");
				out.print("<br>");
				out.print("<b>You can now go back to the Dashboard to see that we have added you to the wiaitlist for your flight.</b>");
		...
		// find a new seat number for the person and then using the info, make a flight tcket for them
			...
			out.print("<br><b> We have placed your reservation for this flight. You can view this change in your login dashboard. </b>");
			out.print("<br>");
...
<br> <br> <form method = "post" action = "CustomerPage.jsp"> <input type = "submit" value = "Dashboard"></form>  <br>
</body>
</html>