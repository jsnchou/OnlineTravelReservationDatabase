...
<title>Customer Rep Book or Reserve Multi-Stop Flights Page</title>
</head>
<body>
...
try {
	...
	// variables used to connect to the DB and send SQL quereies
		...
		try {
			out.print("<h4> Here is info about your FIRST flight:</h4>");
			//connect to the database
					...
					out.print("<h4> Here is info about your SECOND flight:</h4>");
					//connect to the database
							db = new ApplicationDB();	
							con = db.getConnection();
			...
			<form action = "CRBookOrReserveMultiStopFlightsConfirmation.jsp" method="post">
			...
			<input name="CustomerToHelp" type="hidden" value="<%out.print(request.getParameter("CustomerToHelp"));%>">
	...
	out.print("<h3> Please go back and make sure that you CHOOSE ONE PAIR of flights.</h3>");
}
