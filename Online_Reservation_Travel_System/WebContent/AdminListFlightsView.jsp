...
<title>Administrator: View Flights for Airport</title>
</head>
<body>
...
<form method="post" action="AdminListFlightsSelection.jsp">
	<input type="submit" value="View flights for a different airport">
</form>
...
ps = con.prepareStatement("SELECT * FROM OnlineResTravelSystem.Flight WHERE departure_airport_ID = ? OR arrival_airport_ID = ?");
ps.setString(1,airportID);
