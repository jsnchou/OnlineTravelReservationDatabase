...
<title>Customer Rep Reservation Actions Page</title>
</head>
<body>
...
try {
	...
	if (action.equals("DELETE")){
		...
		out.print("<br><b>The reservation has been deleted. Now you have the ability to choose this ticket and buy it. </b><br>");
		...
		%> </table> 
		<br><div><input  type = "submit" value = "BOOK!" style="font-size:100%; height:40px; width:80px; font-weight:bold;"><input type = "hidden" name = "CustomerToHelp" value = "<%out.print(request.getParameter("CustomerToHelp"));%>"></div>
		</form>
		<% 
		}
