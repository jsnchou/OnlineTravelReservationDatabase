...
<title>Multi-Stop Confirmation Page</title>
</head>
<body>
...
//-----------------------------------------------------------------------------------------------------------------------------------
			...
			if ((departureFlightGood == false) && (returningFlightGood == false)) {
				...
				try {
					ps.executeUpdate();
					out.print("<br><b>Sorry. It seems that the first flight that you want to book is currently full. We have added you to the waiting list for the flight. You can see this change on your Dashboard.</b><br>");
				} catch (Exception ex) {
					out.print("<br><b>You are still on the waitlist for the first flight. Please wait until more seats are available. Thank you.</b>");
				}
				...
				try {
					ps.executeUpdate();
					out.print("<br><b>Sorry. It seems that the second flight that you want to book is currently full. We have added you to the waiting list for the flight. You can see this change on your Dashboard/</b><br>");
				} catch (Exception ex) {
					out.print("<br><b>You are still on the waitlist for the second flight. Please wait until more seats are available. Thank you.</b>");
				}
				...
				out.print("<br><b>The first flight is available, however, the second flight is fully booked/reserved at this time. Thus, you cannot purchase a ticket for both. Sorry for this inconvenience.");
				// cannot do anything if one flight is good and the other is not
			} else if ((departureFlightGood == false) && (returningFlightGood == true)) {
				out.print("<br><b>The second flight is available, however, the first flight is fully booked/reserved at this time. Thus, you cannot purchase a ticket for both. Sorry for this inconvenience.");
...
//-----------------------------------------------------------------------------------------------------------------------------------
			...
			if ((departureFlightGood == false) && (returningFlightGood == false)) {
				...
				out.print("<br><b>The first flight is available, however, the second flight is fully booked/reserved at this time. Thus, you cannot reserve a seat for both. Sorry for this inconvenience.");
				// cannot do anything if one flight is good and the other is not
			} else if ((departureFlightGood == false) && (returningFlightGood == true)) {
				out.print("<br><b>The second flight is available, however, the first flight is fully booked/reserved at this time. Thus, you cannot reserve a seat for both. Sorry for this inconvenience.");
				// make two seperate flight tickets under the customer ID
			} else {
